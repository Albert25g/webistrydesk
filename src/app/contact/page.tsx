  ...
  return (
    <div className="template-style">
      ...
      <main className="relative overflow-hidden min-h-screen">
        ...
        <div className="template-hero">
          <div className="text-center max-w-4xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-6">
              Ready to
              <br />
              <span style={{ color: 'var(--webistry-secondary)' }}>Multiply Your Revenue?</span>
            </h1>
              ...
              <div className="space-y-8">
                ...
                <div className="template-card">
                  ...
                  <div className="grid grid-cols-2 gap-6 text-center">
                    <div className="template-card">
                      <div className="text-2xl font-bold mb-1" style={{ color: 'var(--webistry-primary)' }}>340%</div>
                      <div className="text-sm text-gray-300">Average ROI Increase</div>
                    </div>
                    <div className="template-card">
                      <div className="text-2xl font-bold mb-1" style={{ color: 'var(--webistry-secondary)' }}>R2.4M+</div>
                      <div className="text-sm text-gray-300">Revenue Generated</div>
                    </div>
                    <div className="template-card">
                      <div className="text-2xl font-bold mb-1" style={{ color: 'var(--webistry-gold)' }}>48hrs</div>
                      <div className="text-sm text-gray-300">Response Time</div>
                    </div>
                    <div className="template-card">
                      <div className="text-2xl font-bold mb-1" style={{ color: 'var(--webistry-primary)' }}>100%</div>
                ...
                {/* Direct Contact */}
                <div className="template-card" style={{ backgroundColor: 'var(--webistry-primary)' }}>
                  <h3 className="text-xl font-bold mb-4 text-white">Prefer to Talk?</h3>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <div>
                        <div className="font-semibold text-white">+27 79 730 2436</div>
                    ...
                    >
                      ...
                      <div>
                        <div className="font-semibold text-white">hello@webistrydesk.com</div>
        ...
        {/* FAQ Section */}
        <div className="py-20 px-6" style={{ backgroundColor: 'rgba(27, 59, 111, 0.1)' }}>
