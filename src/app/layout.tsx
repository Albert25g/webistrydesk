...
export const metadata: Metadata = {
  ...
  description: 'Transform your business with WebistryDesk\'s proven revenue-generating web solutions. From R15k+ websites to R50M+ e-commerce platforms. 94% client revenue increase guaranteed.',
  keywords: 'web development, e-commerce, digital marketing, SEO, branding, revenue generation, South Africa',
}
